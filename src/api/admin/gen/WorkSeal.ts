...
import type { CreateWorkSealViewModel, WorkSeal, WorkSealViewModel, GetParams, UpdateWorkSealViewModel, EditParams, CancelParams, WorkApprovalRequest, PublishParams, QueryRequest, PageResponseOfWorkSealViewModel, QueryParams, RejectParams } from "./typings"
...
/** 此处后端没有提供注释 GET /api/WorkSeal/${param0} */
export async function Get(
    ...
    return request<WorkSealViewModel>(`${admin_app_api_base_url}/api/WorkSeal/${param0}`, {
        method: 'GET',
        params: { ...queryParams },
        ...(options || {}),
    });
