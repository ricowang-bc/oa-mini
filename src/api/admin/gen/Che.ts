...
import type { CreateCheViewModel, Che, CheViewModel, GetParams, UpdateCheViewModel, EditParams, CancelParams, WorkApprovalRequest, PublishParams, QueryRequest, PageResponseOfCheViewModel, QueryParams, RejectParams } from "./typings"
...
export async function Get(
  ...
  return request<CheViewModel>(`${admin_app_api_base_url}/api/Che/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
