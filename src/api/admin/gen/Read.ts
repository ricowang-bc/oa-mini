...
import type { CreateReadViewModel, Read, ReadViewModel, GetParams, UpdateReadViewModel, EditParams, CancelParams, WorkApprovalRequest, PublishParams, QueryRequest, PageResponseOfReadViewModel, QueryParams, RejectParams } from "./typings"
...
/** 此处后端没有提供注释 GET /api/Read/${param0} */
export async function Get(
  ...
  return request<ReadViewModel>(`${admin_app_api_base_url}/api/Read/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  });
